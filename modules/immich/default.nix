...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers = {
      immich-server = {
        autoStart = true;
        image = "ghcr.io/imagegenius/immich:1.134.0@sha256:4cbf6d1ec09f90aff641e202c3eace2ae16543521dbaac0fddcc5ff1da6eb11f";
        volumes = [
      ...
      immich-redis = {
        autoStart = true;
        image = "valkey/valkey:8-bookworm@sha256:a19bebed6a91bd5e6e2106fef015f9602a3392deeb7c9ed47548378dcee3dfc2";
        environmentFiles = [ cfg.envFile ];
        extraOptions = [ "--network=immich-bridge" ];
      };
