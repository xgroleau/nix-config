...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers = {
      immich-server = {
        autoStart = true;
        image = "ghcr.io/imagegenius/immich:1.140.1@sha256:9034cd6ab5f43b28f52ac2fc98e62e6481a2236470fb414e098c7b5775da5788";
        volumes = [
      ...
      immich-redis = {
        autoStart = true;
        image = "valkey/valkey:8-bookworm@sha256:a137a2b60aca1a75130022d6bb96af423fefae4eb55faf395732db3544803280";
        environmentFiles = [ cfg.envFile ];
        extraOptions = [ "--network=immich-bridge" ];
      };
